<template>
  <!-- <div>标题</div> -->
  <el-tabs tab-position="left" v-model="activeName" @tab-click="handleClick" style="height: 100vh" class="demo-tabs">
...
import demo6 from '@/views/practice/ReactiveDemo.vue'
  ...
  let currentComp = shallowRef(demo1)
